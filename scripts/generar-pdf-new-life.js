...
<body>
    ...
    <div class="page-break">
        ...
        <div style="margin: 30px 0;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 15px 0; border-bottom: 1px solid #e0e0e0;">
                <span style="font-weight: 600; color: #2c3e50;">7. Promociones y Servicios Adicionales</span>
                <span style="color: #667eea; font-weight: 600;">Página 15</span>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 15px 0; border-bottom: 1px solid #e0e0e0;">
                <span style="font-weight: 600; color: #2c3e50;">8. Preguntas Frecuentes</span>
                <span style="color: #667eea; font-weight: 600;">Página 19</span>
            </div>
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 15px 0;">
                <span style="font-weight: 600; color: #2c3e50;">9. Soporte y Contacto</span>
                <span style="color: #667eea; font-weight: 600;">Página 21</span>
            </div>
        </div>
    ...
    <!-- SECCIÓN 7: PROMOCIONES Y SERVICIOS ADICIONALES -->
    <div class="page-break">
        <h1>7. Promociones y Servicios Adicionales</h1>
        
        <div class="seccion-cancha">
            <h3>🎯 Sistema de Promociones</h3>
            <p>El sistema ReservaTusCanchas incluye funcionalidades avanzadas para crear y gestionar promociones especiales que ayuden a aumentar la ocupación y atraer nuevos clientes.</p>
            
            <h4>📅 Cómo Generar Promociones</h4>
            <ul>
                <li>Acceder al panel de administración como Owner.</li>
                <li>Ir a la sección "Promociones" en el menú principal.</li>
                <li>Seleccionar "Crear Nueva Promoción".</li>
                <li>Configurar tipo de descuento (porcentaje o monto fijo).</li>
                <li>Establecer fechas de vigencia de la promoción.</li>
                <li>Definir canchas y horarios aplicables.</li>
                <li>Activar la promoción para que esté disponible.</li>
            </ul>
            
            <h4>⏰ Condiciones de las Promociones</h4>
            <div class="cuadro-importante">
                <h3>📋 Política de Anticipación</h3>
                <p><strong>Las promociones deben realizarse con una semana de anticipación mínima.</strong></p>
                <ul>
                    <li>Permite planificación adecuada de recursos.</li>
                    <li>Facilita la comunicación a los clientes.</li>
                    <li>Evita conflictos con reservas ya confirmadas.</li>
                    <li>Permite ajustes en la programación del complejo.</li>
                </ul>
            </div>
        </div>
        
        <div class="seccion-cancha">
            <h3>🎫 Sistema de Cupones de Descuento</h3>
            <p>Los cupones de descuento son una herramienta poderosa para incentivar reservas y fidelizar clientes.</p>
            
            <h4>💳 Tipos de Cupones Disponibles</h4>
            <ul>
                <li><strong>Cupones de Porcentaje:</strong> Descuento del 10%, 20%, 30%, etc.</li>
                <li><strong>Cupones de Monto Fijo:</strong> Descuento de $5.000, $10.000, etc.</li>
                <li><strong>Cupones de Primera Reserva:</strong> Para nuevos clientes.</li>
                <li><strong>Cupones de Temporada:</strong> Para fechas específicas.</li>
                <li><strong>Cupones de Fidelidad:</strong> Para clientes frecuentes.</li>
            </ul>
            
            <h4>🔧 Gestión de Cupones</h4>
            <ul>
                <li>Crear cupones con códigos únicos.</li>
                <li>Establecer límites de uso por cupón.</li>
                <li>Definir fechas de expiración.</li>
                <li>Configurar restricciones por tipo de cancha.</li>
                <li>Monitorear uso y efectividad de cupones.</li>
            </ul>
        </div>
        
        <div class="seccion-cancha">
            <h3>📝 Instructivo para Generar Reservas desde el Panel</h3>
            <p>Los administradores pueden crear reservas directamente desde el panel de administración para casos especiales o reservas telefónicas.</p>
            
            <h4>📋 Proceso Paso a Paso</h4>
            <div class="paso">
                <h4>Paso 1: Acceder al Panel</h4>
                <p>Iniciar sesión como Owner o Manager en el panel de administración.</p>
            </div>
            
            <div class="paso">
                <h4>Paso 2: Ir a Gestión de Reservas</h4>
                <p>Hacer clic en "Reservas" en el menú principal del panel.</p>
            </div>
            
            <div class="paso">
                <h4>Paso 3: Crear Nueva Reserva</h4>
                <p>Hacer clic en el botón "Nueva Reserva" o "+" en la esquina superior derecha.</p>
            </div>
            
            <div class="paso">
                <h4>Paso 4: Seleccionar Cancha y Horario</h4>
                <p>Elegir la cancha específica y el horario deseado del calendario disponible.</p>
            </div>
            
            <div class="paso">
                <h4>Paso 5: Completar Datos del Cliente</h4>
                <p>Ingresar nombre, teléfono, email y cualquier información adicional del cliente.</p>
            </div>
            
            <div class="paso">
                <h4>Paso 6: Configurar Tipo de Pago</h4>
                <p>Seleccionar si es pago completo, parcial (50%) o reserva sin pago inicial.</p>
            </div>
            
            <div class="paso">
                <h4>Paso 7: Aplicar Descuentos (Opcional)</h4>
                <p>Si aplica, ingresar código de cupón o aplicar descuento manual.</p>
            </div>
            
            <div class="paso">
                <h4>Paso 8: Confirmar Reserva</h4>
                <p>Revisar todos los datos y hacer clic en "Confirmar Reserva".</p>
            </div>
            
            <div class="cuadro-info">
                <h3>💡 Notas Importantes</h3>
                <ul>
                    <li>Las reservas administrativas aparecen marcadas como "Reserva Administrativa".</li>
                    <li>Se puede enviar confirmación por email al cliente automáticamente.</li>
                    <li>Las reservas administrativas tienen comisión reducida (1.75% + IVA).</li>
                    <li>Se puede modificar o cancelar la reserva desde el panel.</li>
                </ul>
            </div>
        </div>
        
        <div class="seccion-cancha">
            <h3>🎨 Servicios de Gráficas Publicitarias</h3>
            <p>ReservaTusCanchas ofrece servicios profesionales de diseño gráfico para potenciar la presencia digital de su complejo.</p>
            
            <h4>📱 Servicios Incluidos</h4>
            <ul>
                <li><strong>Diseño de Posts para Redes Sociales:</strong> Instagram, Facebook, WhatsApp.</li>
                <li><strong>Banners Promocionales:</strong> Para promociones y eventos especiales.</li>
                <li><strong>Stories Dinámicos:</strong> Contenido atractivo para Instagram Stories.</li>
                <li><strong>Material para WhatsApp Business:</strong> Imágenes optimizadas para chat.</li>
                <li><strong>Códigos QR Personalizados:</strong> Para facilitar reservas directas.</li>
                <li><strong>Plantillas Reutilizables:</strong> Para mantener consistencia visual.</li>
            </ul>
            
            <h4>🎯 Beneficios de las Gráficas Publicitarias</h4>
            <ul>
                <li>Mayor engagement en redes sociales.</li>
                <li>Profesionalismo en la comunicación visual.</li>
                <li>Incremento en las reservas online.</li>
                <li>Diferenciación de la competencia.</li>
                <li>Mejor aprovechamiento de promociones.</li>
            </ul>
            
            <div class="cuadro-importante">
                <h3>📞 Solicitar Servicios de Diseño</h3>
                <p>Para solicitar servicios de gráficas publicitarias personalizadas:</p>
                <ul>
                    <li><strong>Email:</strong> contacto@reservatuscanchas.cl</li>
                    <li><strong>Teléfono:</strong> +56 9 8891 9588</li>
                    <li><strong>Horario:</strong> Lunes a Viernes, 9:00 - 18:00 hrs</li>
                </ul>
                <p>Incluya en su solicitud: tipo de evento/promoción, fechas, colores preferidos y mensaje principal.</p>
            </div>
        </div>
    </div>
    ...
    <!-- SECCIÓN 9: SOPORTE Y CONTACTO -->
    <div class="page-break">
        <h1>9. Soporte y Contacto</h1>

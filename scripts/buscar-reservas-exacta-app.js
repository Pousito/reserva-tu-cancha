...
/**
 * 🔍 BÚSQUEDA DE RESERVAS CON CONSULTA EXACTA DE LA APP
 * 
...
class BusquedaReservasExactaApp {
    constructor() {
        this.pool = null;
    ...
    async buscarReservasExactaApp() {
        console.log('\n🔍 BUSCANDO RESERVAS CON CONSULTA EXACTA DE LA APP...');
    ...
    async buscar() {
        console.log('🔍 BÚSQUEDA DE RESERVAS CON CONSULTA EXACTA DE LA APP');
        console.log('=' .repeat(60));
        ...
        const reservas = await this.buscarReservasExactaApp();
...
if (require.main === module) {
    const busqueda = new BusquedaReservasExactaApp();
    busqueda.buscar().catch(console.error);
}

module.exports = BusquedaReservasExactaApp;

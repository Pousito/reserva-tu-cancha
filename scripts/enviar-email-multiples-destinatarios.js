 ...
 * a múltiples destinatarios con valores corregidos
 */

const nodemailer = require('nodemailer');
require('dotenv').config();

async function enviarEmailMultiplesDestinatarios() {
    try {
    ...
    <div style="background-color: white; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <div style="display: flex; justify-content: space-between; margin: 10px 0; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
                ...
                <span style="color: #212529;">Complejo Deportivo</span>
            </div>
            <div style="display: flex; justify-content: space-between; margin: 10px 0; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
            ...
            <div style="display: flex; justify-content: space-between; margin: 10px 0; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
                ...
                <span style="color: #212529;">2025-01-15</span>
            </div>
            <div style="display: flex; justify-content: space-between; margin: 10px 0; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
                <span style="font-weight: bold; color: #495057;">Horario:</span>
                <span style="color: #212529;">18:00 - 19:00</span>
            </div>
            <div style="display: flex; justify-content: space-between; margin: 10px 0; padding: 8px 0; border-bottom: 1px solid #e9ecef;">
...
Gracias por elegir Reserva Tu Cancha!
        ...
        console.log('\n📧 Enviando email a múltiples destinatarios...');
        ...
        console.log('\n✅ Email enviado exitosamente a todos los destinatarios');
...
enviarEmailMultiplesDestinatarios()
    .then(() => {
        console.log('\n✅ Proceso completado');
        process.exit(0);
    })

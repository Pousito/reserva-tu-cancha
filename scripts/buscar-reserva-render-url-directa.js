...
const DATABASE_URL_RENDER = 'postgresql://postgres:r1a3b5c7d9e11f13g15h17i19j21k23l25m27n29o31p33@dpg-d2uhibjuibrs73fm8ec0-a.oregon-postgres.render.com/reservatucancha_db';

async function buscarYMostrarReserva() {
    const pool = new Pool({
        connectionString: DATABASE_URL_RENDER,
    ...
    try {
        console.log('🔌 Conectando a base de datos de Render (producción)...');

 ...
 * con horario y fecha corregidos
 */

const nodemailer = require('nodemailer');
require('dotenv').config();

async function enviarEmailCorregido() {
    try {
        ...
        const horaFin = '22:00'; // 10 PM (asumiendo 1 hora de duración)

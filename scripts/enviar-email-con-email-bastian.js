 ...
 * a múltiples destinatarios, pero con el email de Bastián en el contenido
 */

const nodemailer = require('nodemailer');
require('dotenv').config();

async function enviarEmailConEmailBastian() {
    try {
...
Gracias por elegir Reserva Tu Cancha!
        ...
        console.log('\n📧 Enviando emails con email de Bastián en el contenido...');
        console.log('Destinatarios:', destinatarios.join(', '));
        console.log(`Email en el contenido: ${emailBastian}\n`);
        ...
        for (const destinatario of destinatarios) {
            try {
                ...
                console.log(`   Email en contenido: ${emailBastian}`);
